...
urlpatterns = [
	...
	path('activities/construction/', activities_views.construction_list, name='construction_list'),
	path('activities/construction/<int:pk>/', activities_views.construction_detail, name='construction_detail'),
